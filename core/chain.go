...
// transactions. There should only be a single implementation in Lightchain. For
// the purposes of Lightchain, it should be support retrieving headers and
// consensus parameters from  the current blockchain to be used during
// transaction processing.
//
// NOTE: Lightchain will distribute the fees out to validators, so the structure
