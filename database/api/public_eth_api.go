...
func NewPublicEthAPI(conAPI conAPI.API) *PublicEthAPI {
	return &PublicEthAPI{conAPI}
}
...
// Syncing returns whether or not the current node is syncing with other peers.
//
// Returns false if not, or a struct outlining the state of the sync if it is.
//
// Bad design returning both boolean/struct but must satisfy the public eth API.
func (e *PublicEthAPI) Syncing() (interface{}, error) {
	progress, err := e.conAPI.SyncProgress()
	if err != nil {
...
func (e *PublicEthAPI) GetTransactionByHash(hash common.Hash) *RPCTransaction {
	return nil
}

// GetTransactionByBlockHashAndIndex returns the transaction identified by hash and index.
func (e *PublicEthAPI) GetTransactionByBlockHashAndIndex(hash common.Hash, idx hexutil.Uint) *RPCTransaction {
	return nil
}

// GetTransactionByBlockNumberAndIndex returns the transaction identified by number and index.
func (e *PublicEthAPI) GetTransactionByBlockNumberAndIndex(blockNumber rpc.BlockNumber, idx hexutil.Uint) *RPCTransaction {
	return nil
}
